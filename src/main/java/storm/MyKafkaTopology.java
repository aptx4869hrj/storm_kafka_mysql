...
public class MyKafkaTopology {
    ...
    public static void main(String[] args) throws AlreadyAliveException, InvalidTopologyException, InterruptedException {
        String zks = "172.17.11.141:2181,172.17.11.144:2181,172.17.11.145:2181";
        ...
        spoutConf.zkServers = Arrays.asList(new String[] {"172.17.11.141", "172.17.11.144", "172.17.11.145"});
